...
@Component({
  selector: 'app-residente-antecedentes',
  templateUrl: './residente-antecedentes.page.html',
  styleUrls: ['./residente-antecedentes.page.scss'],
})
export class ResidenteAntecedentesPage implements OnInit {
  ...
  actualizarAntecedentes(){
    ...
    this.residenteService.actualizarAntecedentes(this.usuario.id,{data:this.antecedentesForm.value}).subscribe(u => {
      //console.log(this.usuario);
      console.log(u);
      this.residenteService.residente = u['data'];
      this.usuario = u['data'];
