...
@Component({
  selector: 'app-usuario-signos-vitales',
  templateUrl: './usuario-signos-vitales.page.html',
  styleUrls: ['./usuario-signos-vitales.page.scss'],
})
export class UsuarioSignosVitalesPage implements OnInit {
  ...
  registrarSignosVitales(){
    ...
    if(Object.keys(data).length){
      this.authService.registrarSignosVitales(this.usuario.id,{data:data}).subscribe(usuario => {
        //console.log(data[]);
