...
@Component({
  selector: 'app-usuario-sintomas',
  templateUrl: './usuario-sintomas.page.html',
  styleUrls: ['./usuario-sintomas.page.scss'],
})
export class UsuarioSintomasPage implements OnInit {
  ...
  registrarSintomas(){
    ...
    if(Object.keys(this.data).length){
      ...
      this.authService.registrarSintomas(this.usuario.id,{data:this.data}).subscribe(usuario => {
        if(this.validarObjetoCAM()){
          this.authService.registrarCAM(this.usuario.id,{data:[this.datosUsuarioForm.value['cam']]}).subscribe(usuario =>{
